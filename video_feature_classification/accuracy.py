...
class Accuracy:
    ...
    def by_frames(self, predict):
        ...
        logging.info(classification_report(self.target_all, predict, target_names=self.target_names))
    ...
    def by_clips(self, predict):
        ...
        logging.info(classification_report(self.target_clips, predict_clips, target_names=self.target_names))
