...
from STML_projects.pytorch.common.audio_processor import LibrosaAudioProcessor
from STML_projects.pytorch.common.group_random_sampler import GroupRandomSampler
from STML_projects.python_common.stc_pycommon.logging.logging_control import create_logger
from STML_projects.pytorch.common.losses import *
from STML_projects.pytorch.common.batcher.batch_processor import SimpleBatchProcessor

import torch.optim as optim

from STML_projects.pytorch.AEmotionNet.models.stp_net import STPNet
from STML_projects.pytorch.AEmotionNet.accuracy import Accuracy, Accuracy3D
...
# arguments_parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    config = '/home/mdomrachev/Data/STML_projects/pytorch/AEmotionNet/config.yml'
    host = 'local'
