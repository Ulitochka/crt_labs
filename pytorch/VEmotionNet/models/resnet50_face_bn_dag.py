...
class Resnet50_face_bn_dag(nn.Module):
    ...
    def forward(self, input):
        ...
        prediction_avg = self.prediction_avg(conv5_3)
        prediction = self.prediction(prediction_avg)
        return data, prediction

def resnet50_face_bn_dag(weights_path=None, **kwargs):
    """
