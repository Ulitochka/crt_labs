...
from STML_projects.pytorch.VEmotionNet.models.pretrained_net import CNNNet
...
def train():
    ...
    config = '/home/mdomrachev/Data/STML_projects/pytorch/VEmotionNet/config.yml'
    host = 'local'
